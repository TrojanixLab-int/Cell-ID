...
class AdvancedCellAnalyzer:
    def __init__(self, root):
        ...
        self.load_settings()
        self.root.geometry(f"1000x740+{self.window_x}+{self.window_y}")
        self.root.deiconify()
...
Die Netzbetreiber alle paar Jahre, weshalb die Zuordnung der MNC zu einem Netzbetreiber von diesem Programm wie folgt interpretiert wird und sich jederzeit wieder ändern kann (Stand Februar 2026, Angaben ohne Gewähr):
